    ...
    public:
        ...
        Qty match(NewOrder aggressive, OnTrade on_trade)
        {
            ...
            auto crosses = [&](Price opp_price) -> bool {
                if (aggressive.side == Side::Buy) return aggressive.price >= opp_price;
